        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="col-span-12 xl:col-span-4 md:col-span-6 admin-only">
                    <a href="/OMS/order_management/dist/users/users.php" class="card-link">
                        <div class="card">
                            <div class="card-header !pb-0 !border-b-0">
                                <h5>Total Users</h5>
                ...
                <!-- Total Customers -->
                <div class="col-span-12 xl:col-span-4 md:col-span-6">
                    <a href="/OMS/order_management/dist/customers/customer_list.php" class="card-link">
                        <div class="card">
                            <div class="card-header !pb-0 !border-b-0">
                                <h5>Total Customers
                                    <?php if (!$rbac->isAdmin()): ?>
                ...
                <div class="col-span-12 xl:col-span-4 md:col-span-6">
                    <a href="/OMS/order_management/dist/products/product_list.php" class="card-link">
                        <div class="card">
                            <div class="card-header !pb-0 !border-b-0">
