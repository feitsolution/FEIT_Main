...
<td class="actions">
    ...
    <?php include($_SERVER['DOCUMENT_ROOT'] . '/OMS_management/dist/include/order_view_modal.php'); ?>

<!-- Modal for Marking Order as Paid -->
   <?php include($_SERVER['DOCUMENT_ROOT'] . '/OMS_management/dist/include/paid_mark_modal.php'); ?>

<!-- DISPATCH MODAL HTML -->
   <?php include($_SERVER['DOCUMENT_ROOT'] . '/OMS_management/dist/include/dispatch_modal.php'); ?>

<!-- BULK DISPATCH MODAL HTML  -->
   <?php include($_SERVER['DOCUMENT_ROOT'] . '/OMS_management/dist/include/bulk_dispatch_modal.php'); ?>

<!-- ANSWER STATUS MODAL -->
 <?php include($_SERVER['DOCUMENT_ROOT'] . '/OMS_management/dist/include/answer_status_modal.php'); ?>


<!-- Cancel Order Modal  -->
 <?php include($_SERVER['DOCUMENT_ROOT'] . '/OMS_management/dist/include/cancel_order_modal.php'); ?>

<!--  ADD THE API DISPATCH MODAL HTML -->
 <?php include($_SERVER['DOCUMENT_ROOT'] . '/OMS_management/dist/include/api_dispatch.php'); ?>
...
function viewPaymentSlip() {
    ...
    const slipUrl = '/OMS_management/dist/uploads/payment_slips/' + encodeURIComponent(currentPaymentSlip);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <?php include($_SERVER['DOCUMENT_ROOT'] . '/OMS_management/dist/include/footer.php'); ?>
    <?php include($_SERVER['DOCUMENT_ROOT'] . '/OMS_management/dist/include/scripts.php'); ?>
