...
try {
    ...
    $db_path = $_SERVER['DOCUMENT_ROOT'] . '/OMS_management/dist/connection/db_connection.php';
    ...
    $uploadDir = $_SERVER['DOCUMENT_ROOT'] . '/OMS_management/dist/uploads/payment_slips/';
    if (!is_dir($uploadDir)) {
