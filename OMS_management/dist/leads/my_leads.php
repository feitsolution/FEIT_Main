...
<body>
    ...
    function viewPaymentSlip() {
        ...
        const slipUrl = '/OMS_management/dist/uploads/payment_slips/' + encodeURIComponent(currentLeadId) + '.jpg';
    ...
    function printOrder(orderId) {
        ...
        const printUrl = '/OMS_management/dist/orders/download_order_print.php?id=' + encodeURIComponent(orderId.trim());
