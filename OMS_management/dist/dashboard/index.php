...
<head>
    ...
    <?php
    include($_SERVER['DOCUMENT_ROOT'] . '/OMS_management/dist/include/head.php');
    ?>
...
<body>
    <!-- LOADER -->
    <?php
        include($_SERVER['DOCUMENT_ROOT'] . '/OMS_management/dist/include/loader.php');
    ?>
    <!-- END LOADER -->
        ...
        <div class="pc-content">
            ...
            <div class="grid grid-cols-12 gap-x-6">
                ...
                <div class="col-span-12 xl:col-span-4 md:col-span-6 admin-only">
                    <a href="/OMS_management/dist/users/users.php" class="card-link">
                        <div class="card">
                            <div class="card-header !pb-0 !border-b-0">
                                <h5>Total Users</h5>
                ...
                <!-- Total Customers -->
                <div class="col-span-12 xl:col-span-4 md:col-span-6">
                    <a href="/OMS_management/dist/customers/customer_list.php" class="card-link">
                        <div class="card">
                            <div class="card-header !pb-0 !border-b-0">
                                <h5>Total Customers
                                    <?php if (!$rbac->isAdmin()): ?>
                ...
                <div class="col-span-12 xl:col-span-4 md:col-span-6">
                    <a href="/OMS_management/dist/products/product_list.php" class="card-link">
                        <div class="card">
                            <div class="card-header !pb-0 !border-b-0">
