...
<?php if ($page > 1): ?>
    ...
    <?php include($_SERVER['DOCUMENT_ROOT'] . '/onlineoffers/dist/include/order_view_modal.php'); ?>

<!-- Modal for Marking Order as Paid -->
   <?php include($_SERVER['DOCUMENT_ROOT'] . '/onlineoffers/dist/include/paid_mark_modal.php'); ?>

<!-- DISPATCH MODAL HTML -->
   <?php include($_SERVER['DOCUMENT_ROOT'] . '/onlineoffers/dist/include/dispatch_modal.php'); ?>

<!-- BULK DISPATCH MODAL HTML  -->
   <?php include($_SERVER['DOCUMENT_ROOT'] . '/onlineoffers/dist/include/bulk_dispatch_modal.php'); ?>

<!-- ANSWER STATUS MODAL -->
 <?php include($_SERVER['DOCUMENT_ROOT'] . '/onlineoffers/dist/include/answer_status_modal.php'); ?>


<!-- Cancel Order Modal  -->
 <?php include($_SERVER['DOCUMENT_ROOT'] . '/onlineoffers/dist/include/cancel_order_modal.php'); ?>

<!--  ADD THE API DISPATCH MODAL HTML -->
 <?php include($_SERVER['DOCUMENT_ROOT'] . '/onlineoffers/dist/include/api_dispatch.php'); ?>

<!--  ADD THE CONDITION UPDATE MODAL -->
 <?php include($_SERVER['DOCUMENT_ROOT'] . '/onlineoffers/dist/include/condition_update_modal.php'); ?>
...
function viewPaymentSlip() {
    ...
    const slipUrl = '/onlineoffers/dist/uploads/payment_slips/' + encodeURIComponent(currentPaymentSlip);
