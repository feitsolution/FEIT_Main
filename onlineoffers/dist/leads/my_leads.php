...
<body>
    ...
    function viewPaymentSlip() {
        ...
        const slipUrl = '/onlineoffers/dist/uploads/payment_slips/' + encodeURIComponent(currentLeadId) + '.jpg';
    ...
    function printOrder(orderId) {
        ...
        const printUrl = '/onlineoffers/dist/orders/download_order_print.php?id=' + encodeURIComponent(orderId.trim());
