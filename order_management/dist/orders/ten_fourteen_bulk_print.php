 ...
 * Includes customer phone_2 field
 ...
 * ADDED: phone_2 field from customers table
 */
...
// Fetch branding info (UPDATED VERSION)
$branding_sql = "SELECT * FROM branding WHERE active = 1 ORDER BY branding_id DESC LIMIT 1";
$branding_result = $conn->query($branding_sql);
...
if ($branding_result && $branding_result->num_rows > 0) {
    ...
    $company = [
        ...
        'email'    => $branding['email'] ?? '',
        'phone'    => $branding['hotline'] ?? '',
        'logo_url' => $branding['logo_url'] ?? '' // ADDED: Get logo URL from database
    ];
} else {
    $company = [
        'name'     => 'Company Name',
        ...
        'email'    => '',
        'phone'    => '',
        'logo_url' => '' // ADDED: Default empty logo
    ];
}
?>
...
<body>
    ...
    <!-- <div class="print-instructions">
        <h3>Six by Four Bulk Print Instructions</h3>
        <p><strong>Orders Found:</strong> <?php echo count($orders); ?> orders</p>
        <p><strong>Label Size:</strong> 6 inch × 4 inch (ONE LABEL PER PAGE)</p>
        <p><strong>Format:</strong> Full-page labels with customer phone_2 included</p>
                ...
                <div class="label-wrapper">
                    <div class="receipt-container">
                        ...
                        <table class="main-table">
                            ...
                            <tr>
                               <td class="customer-info" width="50%"> <strong>Name:</strong> <?php echo htmlspecialchars(substr($order['display_name'], 0, 20)); ?><br>
