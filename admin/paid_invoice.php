...
// Fetch only paid invoices - FIXED JOIN CONDITION HERE
...
<head>
    ...
    <title>Paid Invoices - SB Admin</title>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover" id="paidInvoicesTable">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td colspan="8" class="text-center">No paid invoices found</td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
...
<script>
    ...
    window.addEventListener('DOMContentLoaded', event => {
        const paidInvoicesTable = document.getElementById('paidInvoicesTable');
        if (paidInvoicesTable) {
            new simpleDatatables.DataTable(paidInvoicesTable);
        }
    });
</script>
</body>
