    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="invoice-container">
                    <form method="post" action="process_invoice.php" id="invoiceForm" target="_blank">
                        ...
                        <div class="card border mb-3">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h6 class="card-title m-0 fw-bold">Customer Information</h6>
                        ...
                        <div class="card border mb-3">
                            <div class="card-body">
                                <h6 class="card-title mb-3 fw-bold">Products</h6>
                                <div class="table-responsive">
                                    <table class="table" id="invoice_table">
                                        <thead>
                                            <tr>
                                ...
                                <div class="d-flex justify-content-between align-items-start mt-3 flex-wrap">
                                    <button type="button" id="add_product" class="btn btn-outline-success btn-sm mb-3 mb-md-0">
                                        <i class="fas fa-plus me-1"></i> Add Product
                                    </button>
            ...
            <div id="customerModal" class="customer-modal">
                <div class="customer-modal-content">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h5 class="m-0 fw-bold">Select Customer</h5>
                        <span class="close-modal" style="cursor:pointer;font-size:24px;line-height:1;">&times;</span>
                    </div>
                    <div class="input-group mb-4">
                        <span class="input-group-text"><i class="fas fa-search"></i></span>
                        <input type="text" id="customerSearch" class="form-control"
