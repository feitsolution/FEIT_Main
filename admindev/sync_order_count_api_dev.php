...
$_POST['action'] = 'process_sync'; // For testing purposes, you can set this to 'get_start_date' or 'process_sync'.
$_POST['total_orders'] = '10';
$_POST['customer_id'] = 138; // For testing purposes, you can set this to any value or remove it in production.
