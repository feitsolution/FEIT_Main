...
document.getElementById("syncRoyalBtn").addEventListener("click", function() {
    ...
    fetch('/royal_deals/dist/api/royalexpress_webhook.php')
        .then(response => response.json())
        .then(data => {
            btn.disabled = false;
...
document.getElementById("syncTransexpBtn").addEventListener("click", function() {
    ...
    fetch('/royal_deals/dist/api/transexp_webhook.php') // adjust path if needed
        .then(response => response.json())
        .then(data => {
            btn.disabled = false;
...
document.getElementById("syncKoombiyoBtn").addEventListener("click", function() {
    ...
    fetch('/royal_deals/dist/api/koombiyo_webhook.php') // adjust path if needed
        .then(response => response.json())
        .then(data => {
            btn.disabled = false;
