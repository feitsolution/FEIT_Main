...
function setMessageAndRedirect($type, $message, $redirect_url = null) {
    ...
    if (!$redirect_url) {
        $redirect_url = "/royal_deals/dist/orders/create_order.php";
    }
        ...
        if ($courierResult && $courierResult->num_rows > 0) {
            ...
            if ($default_courier_id == 11) {
                if ($courier_type == 1) {
                    ...
                    include($_SERVER['DOCUMENT_ROOT'] . '/royal_deals/dist/api/fde_new_parcel_api.php');
                    ...
                    include($_SERVER['DOCUMENT_ROOT'] . '/royal_deals/dist/api/fde_existing_parcel_api.php');
                ...
                if ($courier_type == 1) {
                    ...
                    $courier_warning = "Koombiyo New Parcel API not yet implemented";
                            ...
                            $api_file_path = $_SERVER['DOCUMENT_ROOT'] . '/royal_deals/dist/api/koombiyo_delivery_api.php';
...
// FIXED TransExpress New Parcel API Integration Section
    ...
    include($_SERVER['DOCUMENT_ROOT'] . '/royal_deals/dist/api/transexpress_new_parcel_api.php');
    ...
    include($_SERVER['DOCUMENT_ROOT'] . '/royal_deals/dist/api/transexpress_existing_parcel_api.php');
    ...
    include($_SERVER['DOCUMENT_ROOT'] . '/royal_deals/dist/api/royal_express_existing_parcel_api.php');
