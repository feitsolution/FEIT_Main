...
<?php if ($page > 1): ?>
    ...
    <?php include($_SERVER['DOCUMENT_ROOT'] . '/royal_deals/dist/include/order_view_modal.php'); ?>

<!-- Modal for Marking Order as Paid -->
   <?php include($_SERVER['DOCUMENT_ROOT'] . '/royal_deals/dist/include/paid_mark_modal.php'); ?>

<!-- DISPATCH MODAL HTML -->
   <?php include($_SERVER['DOCUMENT_ROOT'] . '/royal_deals/dist/include/dispatch_modal.php'); ?>

<!-- BULK DISPATCH MODAL HTML  -->
   <?php include($_SERVER['DOCUMENT_ROOT'] . '/royal_deals/dist/include/bulk_dispatch_modal.php'); ?>

<!-- ANSWER STATUS MODAL -->
 <?php include($_SERVER['DOCUMENT_ROOT'] . '/royal_deals/dist/include/answer_status_modal.php'); ?>


<!-- Cancel Order Modal  -->
 <?php include($_SERVER['DOCUMENT_ROOT'] . '/royal_deals/dist/include/cancel_order_modal.php'); ?>

<!--  ADD THE API DISPATCH MODAL HTML -->
 <?php include($_SERVER['DOCUMENT_ROOT'] . '/royal_deals/dist/include/api_dispatch.php'); ?>

<!--  ADD THE CONDITION UPDATE MODAL -->
 <?php include($_SERVER['DOCUMENT_ROOT'] . '/royal_deals/dist/include/condition_update_modal.php'); ?>
...
function viewPaymentSlip() {
    ...
    const slipUrl = '/royal_deals/dist/uploads/payment_slips/' + encodeURIComponent(currentPaymentSlip);
