...
<body>
    ...
    function viewPaymentSlip() {
        ...
        const slipUrl = '/royal_deals/dist/uploads/payment_slips/' + encodeURIComponent(currentLeadId) + '.jpg';
    ...
    function printOrder(orderId) {
        ...
        const printUrl = '/royal_deals/dist/orders/download_order_print.php?id=' + encodeURIComponent(orderId.trim());
