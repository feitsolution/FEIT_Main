...
<body>
    ...
    function viewPaymentSlip() {
        ...
        const slipUrl = '/digital_stores/dist/uploads/payment_slips/' + encodeURIComponent(currentLeadId) + '.jpg';
    ...
    function printOrder(orderId) {
        ...
        const printUrl = '/digital_stores/dist/orders/download_order_print.php?id=' + encodeURIComponent(orderId.trim());
