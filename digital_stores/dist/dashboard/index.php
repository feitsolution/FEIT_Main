...
include($_SERVER['DOCUMENT_ROOT'] . '/digital_stores/dist/connection/fe_it_db_connection.php');
...
<head>
    ...
    <title>Order Management Admin Portal - Dashboard</title>
      <?php
    include($_SERVER['DOCUMENT_ROOT'] . '/digital_stores/dist/include/head.php');
    ?>
...
<div class="col-span-12 xl:col-span-4 md:col-span-6">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="col-span-12 xl:col-span-4 md:col-span-6 admin-only">
                    <a href="/digital_stores/dist/users/users.php" class="card-link">
                        <div class="card">
                            <div class="card-header !pb-0 !border-b-0">
                                <h5>Total Users</h5>
                ...
                <!-- Total Customers -->
                <div class="col-span-12 xl:col-span-4 md:col-span-6">
                    <a href="/digital_stores/dist/customers/customer_list.php" class="card-link">
                        <div class="card">
                            <div class="card-header !pb-0 !border-b-0">
                                <h5>Total Customers
                                    <?php if (!$rbac->isAdmin()): ?>
                ...
                <div class="col-span-12 xl:col-span-4 md:col-span-6">
                    <a href="/digital_stores/dist/products/product_list.php" class="card-link">
                        <div class="card">
                            <div class="card-header !pb-0 !border-b-0">
   ...
   <!-- FOOTER -->
    <?php
    include($_SERVER['DOCUMENT_ROOT'] . '/digital_stores/dist/include/footer.php');
    ?>
    <!-- END FOOTER -->

    <!-- SCRIPTS -->
    <?php
    include($_SERVER['DOCUMENT_ROOT'] . '/digital_stores/dist/include/scripts.php');
    ?>
    <!-- END SCRIPTS -->
