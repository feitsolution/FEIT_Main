...
<body>
    ...
    <script>
        ...
        function openOrderModal(orderId) {
            ...
            const xhr = new XMLHttpRequest();
            xhr.open('GET', `/digital_stores/dist/ajax/order_details.php?order_id=${orderId}`, true);
            xhr.onload = function() {
                if (xhr.status === 200) {
        ...
        function downloadOrder() {
            ...
            window.open(`/digital_stores/dist/ajax/download_order.php?order_id=${orderId}`, '_blank');
        }
    </script>
</body>
</html>