...
try {
    ...
    $db_path = $_SERVER['DOCUMENT_ROOT'] . '/digital_stores/dist/connection/db_connection.php';
    ...
    if (isset($_FILES['payment_slip']) && $_FILES['payment_slip']['error'] === UPLOAD_ERR_OK) {
        ...
        $uploadDir = $_SERVER['DOCUMENT_ROOT'] . '/digital_stores/dist/uploads/payment_slips/';
        if (!is_dir($uploadDir)) {
