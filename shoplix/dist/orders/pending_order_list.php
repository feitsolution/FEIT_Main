...
if (!isset($_SESSION['logged_in']) || $_SESSION['logged_in'] !== true) {
    ...
    header("Location: /shoplix/dist/pages/login.php");
    exit();
}
...
<?php if ($page > 1): ?>
    ...
    <?php include($_SERVER['DOCUMENT_ROOT'] . '/shoplix/dist/include/order_view_modal.php'); ?>

<!-- Modal for Marking Order as Paid -->
   <?php include($_SERVER['DOCUMENT_ROOT'] . '/shoplix/dist/include/paid_mark_modal.php'); ?>

<!-- DISPATCH MODAL HTML -->
   <?php include($_SERVER['DOCUMENT_ROOT'] . '/shoplix/dist/include/dispatch_modal.php'); ?>

<!-- BULK DISPATCH MODAL HTML  -->
   <?php include($_SERVER['DOCUMENT_ROOT'] . '/shoplix/dist/include/bulk_dispatch_modal.php'); ?>

<!-- ANSWER STATUS MODAL -->
 <?php include($_SERVER['DOCUMENT_ROOT'] . '/shoplix/dist/include/answer_status_modal.php'); ?>


<!-- Cancel Order Modal  -->
 <?php include($_SERVER['DOCUMENT_ROOT'] . '/shoplix/dist/include/cancel_order_modal.php'); ?>

<!--  ADD THE API DISPATCH MODAL HTML -->
 <?php include($_SERVER['DOCUMENT_ROOT'] . '/shoplix/dist/include/api_dispatch.php'); ?>

<!--  ADD THE CONDITION UPDATE MODAL -->
 <?php include($_SERVER['DOCUMENT_ROOT'] . '/shoplix/dist/include/condition_update_modal.php'); ?>
...
function viewPaymentSlip() {
    ...
    const slipUrl = '/shoplix/dist/uploads/payment_slips/' + encodeURIComponent(currentPaymentSlip);
