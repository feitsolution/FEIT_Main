...
<body>
    ...
    function viewPaymentSlip() {
        ...
        const slipUrl = '/shoplix/dist/uploads/payment_slips/' + encodeURIComponent(currentLeadId) + '.jpg';
    ...
    function printOrder(orderId) {
        ...
        const printUrl = '/shoplix/dist/orders/download_order_print.php?id=' + encodeURIComponent(orderId.trim());
