...
<body>
    ...
    function viewPaymentSlip() {
        ...
        const slipUrl = '/zyra_luxe/dist/uploads/payment_slips/' + encodeURIComponent(currentLeadId) + '.jpg';
    ...
    function printOrder(orderId) {
        ...
        const printUrl = '/zyra_luxe/dist/orders/download_order_print.php?id=' + encodeURIComponent(orderId.trim());
