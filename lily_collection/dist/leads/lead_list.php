...
$usersQuery = "SELECT id, name, email FROM users WHERE status = 'active' AND id != 2 ORDER BY name ASC";
...
<body>
    ...
    function viewPaymentSlip() {
        ...
        const slipUrl = '/lily_collection/dist/uploads/payment_slips/' + encodeURIComponent(currentLeadId) + '.jpg';
    ...
    function printOrder(orderId) {
        ...
        const printUrl = '/lily_collection/dist/orders/download_order_print.php?id=' + encodeURIComponent(orderId.trim());
