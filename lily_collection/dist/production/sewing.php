...
$countSql = "SELECT COUNT(*) as total 
             ...
             WHERE pb.current_stage = 'Sewing' AND pb.status = 'Active' AND pb.quantity > 0";
...
<head>
    <title>Sewing Stage - Lily Collection</title>
            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="page-header-title">
                        <h5 class="mb-0 font-medium">Sewing Stage</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="main-content-wrapper">
                    ...
                    <form class="tracking-form" method="GET" action="" style="flex-wrap: wrap; gap: 15px;">
                        ...
                        <div class="form-group" style="display: flex; align-items: flex-end;">
                            <div class="button-group">
                                ...
                                <button type="button" class="search-btn" onclick="window.location.href='sewing.php'" style="background: #6c757d;">
                ...
                <div class="table-wrapper">
                    <table class="orders-table">
                        ...
                        <tbody>
                            <?php if ($sewing_batches && $sewing_batches->num_rows > 0): ?>
                                <?php while ($row = $sewing_batches->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button onclick="transitionStage(<?php echo $row['id']; ?>, 'Finishing', '<?php echo htmlspecialchars($row['reference_no']); ?>')" class="btn btn-sm btn-info">Move to Finishing</button>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            <?php else: ?>
                                <tr><td colspan="8" class="text-center">No batches in sewing stage.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
