...
try {
    ...
    $db_path = $_SERVER['DOCUMENT_ROOT'] . '/lily_collection/dist/connection/db_connection.php';
    ...
    $uploadDir = $_SERVER['DOCUMENT_ROOT'] . '/lily_collection/dist/uploads/payment_slips/';
    if (!is_dir($uploadDir)) {
